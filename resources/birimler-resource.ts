/**
 * BirimlerResource - API resource sınıfı.
 * 
 * @remarks
...
/**
 * Birimler API işlemleri.
 * 
 * @remarks
 * BaseResource sınıfından türetilmiştir.
 * HTTP isteklerini ve validasyonu otomatik olarak yönetir.
 */
export class BirimlerResource extends BaseResource {
    /**
     * BirimlerResource sınıfının yeni bir örneğini oluşturur.
     * 
